...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Sign in — Lovable AI Workplace" },
      { name: "description", content: "Sign in to your AI productivity workspace." },
    ],
  }),
  component: AuthPage,
});
    ...
    <div className="min-h-screen grid place-items-center px-4 py-10">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold gradient-text">Lovable AI Workplace</h1>
        ...
        <div className="glass rounded-2xl p-6">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-11 gradient-bg border-0 text-white hover:opacity-90"
            >
